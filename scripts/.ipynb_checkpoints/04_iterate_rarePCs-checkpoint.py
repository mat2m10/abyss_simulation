...
PC_complete = pd.read_pickle(f"../data/phenotype/PC_and_pop_simulated_veryrare_genotype_AF_{very_rare_threshold_L}_{very_rare_threshold_H}_simulated_geno_G{G}_L{L}_c{c}_k{k}_M{M}.pkl")
...
df_commonPCs["-logP_rare_PC"] = mean_log
df_commonPCs.to_pickle(f"../data/iterative_pvalues/pvals_PCrare_pheno_{name_risk}_G{G}_L{L}_c{c}_k{k}_M{M}.pkl")